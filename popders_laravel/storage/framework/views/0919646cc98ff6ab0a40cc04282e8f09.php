...
<?php $__env->startSection('title', 'Añade tu canción'); ?>
...
<div class="div-content p-10">
  <div class="flex flex-col justify-center items-center">
    <div class="mt-5 md:col-span-2 md:mt-0 max-w-lg col-start-3">
        ...
        <form action="<?php echo e(route('addSong.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <small class="text-rose-500"><?php echo e($message); ?></small>
                    <?php unset($message);
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\popders_laravel\popders_laravel\resources\views/addSong.blade.php ENDPATH**/ ?>