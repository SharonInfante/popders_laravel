...
<div class="div-content flex">
    <span class="menu flex flex-col bg-white  place-self-center">
        <a href="{{ route('home') }}"><img class="w-14 my-3" src="{{ asset('img/icons/logo-popCoder-multicolor.png') }}" alt="logo"></a>
        <a href="{{route('playlist.index')}}"><img class="w-14 my-16"  src="{{ asset('img/icons/icono-gatito.png') }}" alt="logo"></a>
    </span>
