                ...
                <div class="shadow sm:overflow-hidden sm:rounded-md">
                    <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                        <div class="col-span-6 sm:col-span-4">
                            <a href="{{ route('home') }}"> <img class="mx-auto h-24 w-auto"
                                    src="{{ asset('img/icons/logo-popCoder-multicolor.png') }}" alt="logo"></a>
                            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-indigo-600">Edita tu
                                canción</h2>
                        </div>

                        <div class="col-span-6 sm:col-span-4">
                            <label for="title" class="block text-sm font-medium leading-6 text-gray-900">Título</label>
                            <input type="text" name="title" id="title" value="{{$songs->title}}"
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input type="text" name="artist" id="artist" value="{{$songs->artist}}"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-3 sm:col-span-2">
                                ...
                                <div class="mt-2 flex rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="url" id="url" value="{{$songs->url}}"
                        ...
                        <div>
                            <label class="block text-sm font-medium leading-6 text-gray-900">Imagen de tu
                                canción</label>
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file"
                                            ...
                                            <input id="file" name="image" type="file" value="{{$songs->image}}"
