...
$motivation = ['Lunes con L de:Lograr tus objetivos', 'Martes con M de:Magnífico día para todas', 'Miércoles con M
de:Mitad de semana, ¡vamos!', 'Jueves con J de:Jamás rendirte', 'Viernes con V de:Vámonos de juerga', 'Sábado con s
de:Sonríele a la vida', 'Domingo con D de:Duerme todo el día'];
...
<div class="div-content">
    <div class="container flex flex-col bg-stone-50/40 rounded-md max-w-4xl ">
        <div class="flex justify-end mb-16">
            <a href="{{ route('register') }}"><img class="mx-auto h-14 w-auto mr-6"
                    src="{{ asset('img/icons/icono-user-add.png') }}" alt="icono reister"></a>
            <a href="{{ route('login') }}"><img class="mx-auto h-14 w-auto"
                    src="{{ asset('img/icons/login-user.png') }}" alt="icono login"></a>
        </div>
        ...
        <div class="flex justify-centermt-16 mb-12">
            <div class="h-64 w-64 flex justify-center">
                <div
                    class="bg-[url('img/avatares/natalia.png')] rounded-full h-48 w-48 border-4 border-amber-200 text-center flex items-center justify-center">
            ...
            <div class="flex flex-col justify-center">
                ...
                <h2 class='text-center text-white text-2xl leading-loose mr-30'>- {{ $line1 }} -<br />
                    <span class="text-7xl text-amber-200">{{ $line2 }}</span><br />
                    - {{ $line3 }} -
                </h2>
            </div>
        </div>
        <div class="flex justify-center align-bottom">
            <div
                class="rounded-full h-21 w-20 border-4 border-amber-200 text-center flex items-center justify-center m-5">
                <a href="{{ route('playlist.index') }}"><img class="rounded-full h-20 w-20"
                        src="{{ asset('img/avatares/natalia.png') }}" alt="avatar"></a>
            </div>
            <div
                class="rounded-full h-21 w-21 border-4 border-amber-200 text-center flex items-center justify-center m-5">
                <a href="{{ route('playlist.index') }}"><img class="rounded-full h-20 w-20"
                        src="{{ asset('img/avatares/gabriela.png') }}" alt="avatar"></a>
            </div>
            <div
                class="rounded-full h-21 w-21 border-4 border-amber-200 text-center flex items-center justify-center m-5">
                <a href="{{ route('playlist.index') }}"><img class="rounded-full h-20 w-20"
                        src="{{ asset('img/avatares/sharon.png') }}" alt="avatar"></a>
            </div>
            <div
                class="rounded-full h-21 w-21 border-4 border-amber-200 text-center flex items-center justify-center m-5">
                <a href="{{ route('playlist.index') }}"><img class="rounded-full h-20 w-20"
                        src="{{ asset('img/avatares/meena.png') }}" alt="avatar"></a>
            </div>
        </div>
    </div>
</div>
